...
@ExposeToClient
public class manco_rep2 extends JavaServiceSuperClass {
   public DownloadResponse getReport(String idempresa) throws Exception {
       ...
       try {
          ...
          URL fileUrl = this.getClass().getResource("manco_rep_2.jasper");
          ...
          ret.setContentType(mimeFileTypeMap.getContentType("manco_rep_2.jasper"));
